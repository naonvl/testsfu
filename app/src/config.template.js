...
module.exports = {
    ...
    server: {
        ...
        rtmp: {
            /*
                ...
                - server: The URL of the RTMP server. Leave empty to use the built-in Nasdem RTMP server (rtmp://localhost:1935). Change the URL to connect to a different RTMP server.
                ...
                - apiSecret: The API secret for streaming WebRTC to RTMP through the Nasdem API.
    ...
    ui: {
        /*
            Customize your Nasdem instance
        */
        brand: {
            app: {
                name: 'Nasdem Private',
                title: 'Nasdem Private<br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
                description:
                    'Start your next video call with a single click. No download, plug-in, or login is required. Just get straight to talking, messaging, and sharing your screen.',
            },
            site: {
                title: 'Nasdem Private, Free Video Calls, Messaging and Screen Sharing',
                icon: '../images/logo.svg',
                appleTouchIcon: '../images/logo.svg',
            },
            meta: {
                description:
                    'Nasdem Private powered by WebRTC and mediasoup, Real-time Simple Secure Fast video calls, messaging and screen sharing capabilities in the browser.',
                keywords:
                    'webrtc, miro, mediasoup, mediasoup-client, self hosted, voip, sip, real-time communications, chat, messaging, meet, webrtc stun, webrtc turn, webrtc p2p, webrtc sfu, video meeting, video chat, video conference, multi video chat, multi video conference, peer to peer, p2p, sfu, rtc, alternative to, zoom, microsoft teams, google meet, jitsi, meeting',
            },
            og: {
                type: 'app-webrtc',
                siteName: 'Nasdem Private',
                title: 'Click the link to make a call.',
                description: 'Nasdem Private calling provides real-time video calls, messaging and screen sharing.',
