...
/**
 * Nasdem Private - Server component
 *
...
function startServer() {
    ...
    */
    ...
    app.get([restApi.basePath + '/meetings'], (req, res) => {
        ...
        if (!api.isAuthorized()) {
            log.debug('Nasdem get meetings - Unauthorized', {
                header: req.headers,
                body: req.body,
            });
        ...
        log.debug('Nasdem get meetings - Authorized', {
            header: req.headers,
            body: req.body,
            meetings: meetings,
        });
    ...
    app.post([restApi.basePath + '/meeting'], (req, res) => {
        ...
        const api = new ServerApi(host, authorization);
        if (!api.isAuthorized()) {
            log.debug('Nasdem get meeting - Unauthorized', {
                header: req.headers,
                body: req.body,
            });
            return res.status(403).json({ error: 'Unauthorized!' });
        ...
        // log.debug the output if all done
        log.debug('Nasdem get meeting - Authorized', {
            header: req.headers,
            body: req.body,
            meeting: meetingURL,
        });
    ...
    app.post([restApi.basePath + '/join'], (req, res) => {
        ...
        const api = new ServerApi(host, authorization);
        if (!api.isAuthorized()) {
            log.debug('Nasdem get join - Unauthorized', {
                header: req.headers,
                body: req.body,
            });
            return res.status(403).json({ error: 'Unauthorized!' });
        ...
        // log.debug the output if all done
        log.debug('Nasdem get join - Authorized', {
            header: req.headers,
            body: req.body,
            join: joinURL,
        });
    ...
    app.post([restApi.basePath + '/token'], (req, res) => {
        ...
        const api = new ServerApi(host, authorization);
        if (!api.isAuthorized()) {
            log.debug('Nasdem get token - Unauthorized', {
                header: req.headers,
                body: req.body,
            });
            return res.status(403).json({ error: 'Unauthorized!' });
        ...
        // log.debug the output if all done
        log.debug('Nasdem get token - Authorized', {
            header: req.headers,
            body: req.body,
            token: token,
        });
